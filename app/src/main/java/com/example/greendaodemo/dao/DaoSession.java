...
import com.example.greendaodemo.test.UserInfo;
import com.example.greendaodemo.test.UserPhoto;
...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig userPhotoDaoConfig;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        userPhotoDaoConfig = daoConfigMap.get(UserPhotoDao.class).clone();
        userPhotoDaoConfig.initIdentityScope(type);
        ...
        userPhotoDao = new UserPhotoDao(userPhotoDaoConfig, this);
        ...
        registerDao(UserPhoto.class, userPhotoDao);
    }
    ...
    public void clear() {
        ...
        userPhotoDaoConfig.clearIdentityScope();
    }
