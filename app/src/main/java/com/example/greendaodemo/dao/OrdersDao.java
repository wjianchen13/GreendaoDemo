...
public class OrdersDao extends AbstractDao<Orders, Long> {
    ...
    private Query<Orders> user3_OrdersQuery;
    ...
    /** Internal query to resolve the "orders" to-many relationship of User3. */
    public List<Orders> _queryUser3_Orders(Long userId) {
        synchronized (this) {
            if (user3_OrdersQuery == null) {
                QueryBuilder<Orders> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.UserId.eq(null));
                user3_OrdersQuery = queryBuilder.build();
            }
        }
        Query<Orders> query = user3_OrdersQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getUser3Dao().getAllColumns());
            builder.append(" FROM ORDERS T");
            builder.append(" LEFT JOIN USERS3 T0 ON T.\"USER_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Orders loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        User3 user = loadCurrentOther(daoSession.getUser3Dao(), cursor, offset);
        entity.setUser(user);
