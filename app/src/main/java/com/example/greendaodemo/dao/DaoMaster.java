...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        Card1Dao.createTable(db, ifNotExists);
        Card2Dao.createTable(db, ifNotExists);
        ...
        User3Dao.createTable(db, ifNotExists);
        UserInfoDao.createTable(db, ifNotExists);
        UserPhotoDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        Card1Dao.dropTable(db, ifExists);
        Card2Dao.dropTable(db, ifExists);
        ...
        User3Dao.dropTable(db, ifExists);
        UserInfoDao.dropTable(db, ifExists);
        UserPhotoDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(Card1Dao.class);
        registerDaoClass(Card2Dao.class);
        ...
        registerDaoClass(User3Dao.class);
        registerDaoClass(UserInfoDao.class);
        registerDaoClass(UserPhotoDao.class);
    }
